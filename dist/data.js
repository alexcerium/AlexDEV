...
window.SITE = {
    ...
    // Hero Section
    hero: {
        title: "Запускаю сайты и iOS-приложения для бизнеса и брендов",
        bulletPoints: [
            "Лендинги и сайты-каталоги за 7 дней, которые приводят заявки",
    ...
    services: {
        ...
        packages: [
            {
                name: "iOS-приложения для бизнеса",
                duration: "от 4 недель",
                price: "от 20000₽",
                description: "Удобное приложение для бизнеса: от онлайн-меню до push-уведомлений. Постоянный контакт с клиентами — без лишних усилий."
            },
            {
                name: "Рабочие сайты",
                duration: "от 2 недель",
                price: "от 15000₽",
                description: "Быстрый запуск: сайт-визитка или каталог с адаптивным дизайном, чтобы ваш продукт было легко найти и просто купить."
            },
            {
                name: "Пакет «Бренд под ключ»",
                duration: "от 4 недель",
                price: "от 30000₽",
                description: "Сайт показывает вашу экспертизу, соцсети формируют доверие и интерес. Вместе они делают из вас сильный бренд и помогают продавать дороже."
            },
            {
                name: "SMM-продвижение в соцсетях",
                duration: "от 4 недель",
                price: "от 20000₽",
                description: "От стратегии и tone of voice до съёмки и рекламы. Комплексное продвижение, которое превращает подписчиков в клиентов."
            },
            {
                name: "Копирайтинг",
                duration: "3–5 дней",
            ...
            },
            {
                ...
                duration: "до 1 дня",
                price: "Бесплатно",
                description: "Подскажу, какой инструмент принесёт результат именно вам: сайт, приложение или продвижение. Экономим бюджет и время, двигаемся по правильному пути."
            }
        ]
    },
